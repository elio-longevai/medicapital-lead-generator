						...
						<CardContent className="space-y-4">
							<div>
								...
								<Input
									...
									onChange={(e) =>
										setCriteria({ ...criteria, minimumValue: e.target.value })
									}
								/>
							</div>
							...
							<div>
								...
								<Textarea
									...
									onChange={(e) =>
										setCriteria({ ...criteria, industries: e.target.value })
									}
									rows={3}
								/>
							</div>
							...
							<div>
								...
								<Input
									...
									onChange={(e) =>
										setCriteria({ ...criteria, companySize: e.target.value })
									}
								/>
							</div>
							...
							<div className="space-y-3">
								...
								<div>
									...
									<input
										...
										onChange={(e) =>
											setCriteria({
												...criteria,
												financialStability: e.target.value,
											})
										}
										className="w-full"
									/>
								...
								<div>
									...
									<input
										...
										onChange={(e) =>
											setCriteria({
												...criteria,
												equipmentNeedScore: e.target.value,
											})
										}
										className="w-full"
									/>
								...
								<div>
									...
									<input
										...
										onChange={(e) =>
											setCriteria({ ...criteria, timingScore: e.target.value })
										}
										className="w-full"
									/>
								</div>
								...
								<div>
									...
									<input
										...
										onChange={(e) =>
											setCriteria({
												...criteria,
												decisionAuthorityScore: e.target.value,
											})
										}
										className="w-full"
									/>
							...
							<div className="space-y-2">
								<div className="flex justify-between text-sm">
									...
									<span className="font-medium">
										{qualificationStats.totalProcessed}
									</span>
								</div>
								<div className="flex justify-between text-sm">
									<span>In Review</span>
									<span className="font-medium">
										{qualificationStats.inReview}
									</span>
								</div>
								<div className="flex justify-between text-sm">
									<span>Rejected</span>
									<span className="font-medium">
										{qualificationStats.rejected}
									</span>
								</div>
							</div>
						</CardContent>
								...
								<div className="grid grid-cols-1 md:grid-cols-4 gap-4">
									<div className="text-center p-4 bg-blue-50 rounded-lg">
										...
										<p className="text-sm text-blue-700 mt-1">
											Company info, financial data, news
										</p>
									</div>
